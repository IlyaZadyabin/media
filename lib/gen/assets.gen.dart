...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/bars.svg
  SvgGenImage get bars => const SvgGenImage('assets/icons/bars.svg');
  ...
  /// File path: assets/icons/qyre.svg
  SvgGenImage get qyre => const SvgGenImage('assets/icons/qyre.svg');

  /// File path: assets/icons/small_arrow_right.svg
  SvgGenImage get smallArrowRight =>
      const SvgGenImage('assets/icons/small_arrow_right.svg');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/prod1.png
  AssetGenImage get prod1 => const AssetGenImage('assets/images/prod1.png');

  /// File path: assets/images/prod2.png
  AssetGenImage get prod2 => const AssetGenImage('assets/images/prod2.png');

  /// List of all assets
  List<AssetGenImage> get values => [prod1, prod2];
}
