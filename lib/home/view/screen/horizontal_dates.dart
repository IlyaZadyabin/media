...
import 'package:media/home/view/components/date_bar/date_bar.dart';
import 'package:media/home/view/components/date_bar/date_bar_collapsed.dart';
    ...
    return SingleChildScrollView(
      ...
      child: Row(
        children: [
          ...
          ...List.generate(10, (i) => i).map((index) {
            Color? circleColor;
            if (index == 0 || index == 3) {
